...
console.log(initials('Цикл', 'Джаваскриптов', 'Объектович')) 
// должен вывести "Джаваскриптов Ц.О."
...
console.log(filterNames(['code', 'js', 'html', 'git'], 4));
...
console.log(searchWord(['js', 'css', 'php'], 'программирование изменило мою жизнь')); // false
